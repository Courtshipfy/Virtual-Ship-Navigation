...
public class ALG_A : MonoBehaviour
{
    ...
    public List<waypoint> GetPath()
    {
        ...
        PathFinding.Instance.startObj.GetComponent<MeshRenderer>().material.color = Color.yellow;
    ...
    public void A()
    {
        ...
        while (sortList.Count > 0)
        {
            ...
            {
                return (manhattan(PathFinding.Instance.startPoint, a.GetPosition()) + manhattan(PathFinding.Instance.endPoint, a.GetPosition())) 
                       - 
                       (manhattan(PathFinding.Instance.startPoint, b.GetPosition()) + manhattan(PathFinding.Instance.endPoint, b.GetPosition()));
            });
